...
consumer_key = "8TvvYI39t1rj7jugmMY6VI1qm"
consumer_secret = "YhdTr4UVbVAGI4wOJ9Ye5HqShwqXNedlz4jgHNZLgjrcst2WWE"
access_token = "1089879351276040194-EXfz3e3oUil9up2R7zZZknqLLQPf7C"
access_token_secret = "x0Ww2kQ5E3MEO39hIKZPHW2H7igbtUVjUZNZ1g3iiD1Zy"
bearer_token = "AAAAAAAAAAAAAAAAAAAAABOxQgEAAAAAZjq9BFlFm%2FRF21Vn5QHwtdHiQ3Q%3D2pSSlWlnIuDSuVnbhV1BJUuMi5M2tF8TECi1ArK3XLKzlHSgyf"
...
BDD_raw_file = r"C:\Users\guspi\Documents\Ecole\ESSCA\5A\Mémoire\Twitter\V2 - mémoire\2 - BDD raw suite.csv"
...
def get_all_tweets(screen_name, BDD, category):
    ...
    for x in range(len(df)):
        ...
        text = re.sub(r"\@", "", text)
        text = re.sub(r"\-", "", text)    
        # if ("ScamAlert" in text) : print(text)
        ...
        # if x == 0 : print(df.head(4)) ; sys.exit()
