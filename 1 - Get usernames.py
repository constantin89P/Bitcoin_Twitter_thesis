...
# creat New columns : DEFAULT SENTIMENT (no), FILTERED TWEETS (yes)
# Except for : 
# Cryto Influencer, Spécialistes crypto, Crypto compagnies, Cryptocurrencies --> GET ALL TWEETS + Positive sentiment to default 
characteristics = {'Name' : q}
